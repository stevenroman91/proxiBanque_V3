...
public class VirementCompteComponent {
	...
	public void virement(Compte c1, Compte c2, double mt) throws SoldeInsuffisantException, MontantNegatifException{
		//LOGGER.info("le solde est égale à = {}",cr.getSolde(idD));
		if(mt<0) throw new MontantNegatifException("le montant que vous avez saisi est negatif");
